...
`.claude/agents/` contains the four POV agents (engineer, writer, practitioner, skeptic) used to generate the founding research in `research/pov-memos/`. They are available if you need to re-run the research phase for future framework decisions.
